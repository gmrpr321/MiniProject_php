...
$sql_attendance = "SELECT * FROM attendance WHERE Employee_id = $employee_id";
...
while ($row = mysqli_fetch_assoc($attendance_result)) {
  ...
  foreach ($row as $column1 => $column2) {
    if($column1 === 'id' or $column1==='Employee_id' )continue;
      $attendance_row[$column1] = $column2;
  }
  $attendance_array[] = $attendance_row; 
}
 mysqli_close($conn);
?>
<!DOCTYPE html>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="details-container">
        <?php 
      foreach ($attendance_array as $attendance_row) {
